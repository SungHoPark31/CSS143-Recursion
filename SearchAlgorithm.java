...
/**
 * A class used to delegate a search strategy or style. The styles used are 
 * the linear and the binary search.
 *
 * @author: Sung Ho Park
 * Class: CSS 143 B
...
public abstract class SearchAlgorithm 
{
	...
	public abstract int search(String[] words, String wordToFind)
											throws ItemNotFoundException;
    public abstract int recSearch(String[] words, String wordToFind, int start,
    									int end) throws ItemNotFoundException;
